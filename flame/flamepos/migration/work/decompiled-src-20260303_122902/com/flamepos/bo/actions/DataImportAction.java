...
extends AbstractAction {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            DataImportAction.importMenuItemsFromFile(file);
            POSMessageDialog.showMessage(POSUtil.getFocusedWindow(), Messages.getString("DataImportAction.1"));
        }
        catch (Exception e1) {
    ...
    public static void importMenuItemsFromFile(File file) throws Exception {
        ...
        DataImportAction.importMenuItems(inputStream);
    }
    ...
    public static void importMenuItems(InputStream inputStream) throws Exception {
        HashMap<String, Comparable> objectMap = new HashMap<String, Comparable>();
        try {
            ...
            if ((menuCategories = elements.getMenuCategories()) != null) {
            ...
            if ((menuGroups = elements.getMenuGroups()) != null) {
            ...
            if ((menuModifierGroups = elements.getMenuModifierGroups()) != null) {
            ...
            if ((menuModifiers = elements.getMenuModifiers()) != null) {
                for (MenuModifier menuModifier : menuModifiers) {
                    ...
                    if ((tax = menuModifier.getTax()) != null) {
            ...
            if ((menuItemModifierGroups = elements.getMenuItemModifierGroups()) != null) {
            ...
            if ((menuItems = elements.getMenuItems()) != null) {
                for (MenuItem menuItem : menuItems) {
                    ...
                    if ((tax = menuItem.getTax()) != null) {
                        tax = (Tax)objectMap.get(tax.getUniqueId());
                        menuItem.setTax(tax);
                    }
                    if ((menuItemModiferGroups = menuItem.getMenuItemModiferGroups()) != null) {
