...
extends ViewPanel {
    ...
    public SwitchboardOtherFunctionsView() {
        ...
        FlameTheme.styleButton(btnBack);
        ...
        FlameTheme.stylePanel(this.contentPanel, FlameTheme.BACKGROUND_SECONDARY);
        ...
        if (plugins != null) {
            for (FloreantPlugin plugin : plugins) {
                ...
                for (Object action : posActions) {
                    if (!(action instanceof PosAction)) continue;
        ...
        scrollPane.getViewport().setBackground(FlameTheme.BACKGROUND_SECONDARY);
        scrollPane.setBackground(FlameTheme.BACKGROUND_PRIMARY);
        this.add(scrollPane);
    }
