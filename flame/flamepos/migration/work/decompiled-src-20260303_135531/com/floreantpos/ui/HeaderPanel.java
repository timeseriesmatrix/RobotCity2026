...
extends JPanel {
    ...
    public HeaderPanel() {
        ...
        this.setOpaque(true);
        this.setBackground(FlameTheme.BACKGROUND_SECONDARY);
        this.buttonPanel = new JPanel((LayoutManager)new MigLayout("hidemode 3", "", ""));
        this.buttonPanel.setOpaque(true);
        this.buttonPanel.setBackground(FlameTheme.BACKGROUND_SECONDARY);
        ...
        this.logoffLabel.setForeground(FlameTheme.ACCENT_COLOR);
        ...
        FlameTheme.styleButton(this.btnHomeScreen);
        ...
        FlameTheme.styleButton(this.btnMaintainance);
        ...
        FlameTheme.styleButton(this.btnSwithboardView);
        ...
        FlameTheme.styleButton(this.btnOthers);
        ...
        FlameTheme.styleButton(this.btnClockOUt);
        ...
        FlameTheme.styleButton(this.btnLogout);
        ...
        FlameTheme.styleButton(this.btnShutdown);
        ...
        FlameTheme.stylePanel(this.quickMaintenancePanel, FlameTheme.BACKGROUND_SECONDARY);
