...
TicketListUpdateListener {
    ...
    private void initComponents() {
        ...
        this.setOpaque(true);
        this.setBackground(FlameTheme.BACKGROUND_PRIMARY);
        FlameTheme.styleButton(this.btnEditTicket);
        FlameTheme.styleButton(this.btnGroupSettle);
        FlameTheme.styleButton(this.btnOrderInfo);
        FlameTheme.styleButton(this.btnReopenTicket);
        FlameTheme.styleButton(this.btnSettleTicket);
        FlameTheme.styleButton(this.btnSplitTicket);
        FlameTheme.styleButton(this.btnVoidTicket);
        FlameTheme.styleButton(this.btnRefundTicket);
        FlameTheme.styleButton(this.btnAssignDriver);
        FlameTheme.styleButton(this.btnCloseOrder);
        JPanel centerPanel = new JPanel(new BorderLayout(5, 5));
        FlameTheme.stylePanel(centerPanel, FlameTheme.BACKGROUND_PRIMARY);
        JPanel ticketsAndActivityPanel = new JPanel(new BorderLayout(5, 5));
        FlameTheme.stylePanel(ticketsAndActivityPanel, FlameTheme.BACKGROUND_SECONDARY);
        this.ticketsListPanelBorder = BorderFactory.createTitledBorder(null, POSConstants.OPEN_TICKETS_AND_ACTIVITY, 2, 0);
        this.ticketsListPanelBorder.setTitleColor(FlameTheme.ACCENT_COLOR);
        ...
        this.ticketList.setBackground(FlameTheme.BACKGROUND_SECONDARY);
        this.ticketList.setForeground(FlameTheme.TEXT_PRIMARY);
        ...
        FlameTheme.stylePanel(rightPanel, FlameTheme.BACKGROUND_SECONDARY);
        TitledBorder titledBorder2 = BorderFactory.createTitledBorder(null, "-", 2, 0);
        titledBorder2.setTitleColor(FlameTheme.WARM_ACCENT);
        ...
        FlameTheme.stylePanel(this.orderPanel, FlameTheme.BACKGROUND_SECONDARY);
    ...
    private Component createBarTabButton(List<OrderType> orderTypes) {
        ...
        FlameTheme.styleButton(btnNewBarTab);
    ...
    private JPanel createActivityPanel() {
        ...
        FlameTheme.stylePanel(activityPanel, FlameTheme.BACKGROUND_SECONDARY);
        JPanel innerActivityPanel = new JPanel((LayoutManager)new MigLayout("hidemode 3, fill, ins 0", "fill, grow", ""));
        FlameTheme.stylePanel(innerActivityPanel, FlameTheme.BACKGROUND_SECONDARY);
        JPanel firstRowButtonPanel = new JPanel(new GridLayout(1, 0, 5, 5));
        FlameTheme.stylePanel(firstRowButtonPanel, FlameTheme.BACKGROUND_SECONDARY);
        ...
        secondRowButtonPanel.getContentPane().setBackground(FlameTheme.BACKGROUND_SECONDARY);
        ...
        FlameTheme.styleButton(btnMore);
