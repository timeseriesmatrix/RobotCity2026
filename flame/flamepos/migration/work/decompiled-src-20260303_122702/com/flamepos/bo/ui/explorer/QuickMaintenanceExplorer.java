...
public class QuickMaintenanceExplorer
extends TransparentPanel {
    ...
    public QuickMaintenanceExplorer() {
        super((LayoutManager)new MigLayout("inset 0"));
        ...
        this.add((Component)btnCursor, "w " + btnSize + "!, h " + btnSize + "!");
        this.add((Component)btnEdit, "w " + btnSize + "!, h " + btnSize + "!");
        this.add((Component)btnCopy, "w " + btnSize + "!, h " + btnSize + "!");
        this.add((Component)btnDelete, "w " + btnSize + "!, h " + btnSize + "!");
    }

    public static void quickMaintain(Object object) {
        if (object instanceof MenuItem) {
            QuickMaintenanceExplorer.quickMaintainMenuItem((MenuItem)object);
            return;
        }
        ...
        if (object instanceof MenuGroup) {
            QuickMaintenanceExplorer.quickMaintainMenuGroup((MenuGroup)object);
        } else if (object instanceof MenuCategory) {
            QuickMaintenanceExplorer.quickMaintainMenuCategory((MenuCategory)object);
        } else if (object instanceof OrderType) {
            QuickMaintenanceExplorer.quickMaintainOrderType((OrderType)object);
        } else if (object instanceof ShopTable) {
            QuickMaintenanceExplorer.quickMaintainShopTable((ShopTable)object);
        }
    }
        ...
        try {
            if (menuItem.getId() != null) {
                if (btnCopy.isSelected()) {
                    ...
                    PropertyUtils.copyProperties((Object)newMenuItem, (Object)menuItem);
            ...
            BeanEditorDialog dialog = new BeanEditorDialog((Frame)Application.getPosWindow(), (BeanEditor)editor);
            dialog.open();
        ...
        try {
            if (menuGroup.getId() != null) {
                if (btnCopy.isSelected()) {
                    ...
                    PropertyUtils.copyProperties((Object)newMenuGroup, (Object)menuGroup);
                    ...
                    if (menuItems.size() > 0) {
                        if (POSMessageDialog.showYesNoQuestionDialog(POSUtil.getFocusedWindow(), Messages.getString("MenuGroupExplorer.0"), POSConstants.DELETE) != 0) {
                            return;
                        }
        ...
        try {
            if (menuCategory.getId() != null) {
                if (btnCopy.isSelected()) {
                    ...
                    PropertyUtils.copyProperties((Object)newMenuCategory, (Object)menuCategory);
                    ...
                    if (menuGroups.size() > 0) {
                        if (POSMessageDialog.showYesNoQuestionDialog(POSUtil.getFocusedWindow(), Messages.getString("MenuCategoryExplorer.0"), POSConstants.DELETE) != 0) {
                            return;
                        }
        ...
        try {
            if (orderType.getId() != null) {
                if (btnCopy.isSelected()) {
                    ...
                    PropertyUtils.copyProperties((Object)newOrderType, (Object)orderType);
        ...
        try {
            if (shopTable.getId() != null) {
                if (btnCopy.isSelected()) {
                    ...
                    PropertyUtils.copyProperties((Object)newShopTable, (Object)shopTable);
