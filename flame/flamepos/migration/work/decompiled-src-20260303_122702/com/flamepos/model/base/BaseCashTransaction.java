...
public abstract class BaseCashTransaction
...
Serializable {
    ...
    public BaseCashTransaction(Integer id) {
        super(id);
    }

    public BaseCashTransaction(Integer id, String transactionType, String paymentType) {
