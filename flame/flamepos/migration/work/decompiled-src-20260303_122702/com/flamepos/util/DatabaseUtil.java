...
public class DatabaseUtil {
    ...
    public static void checkConnection(String connectionString, String hibernateDialect, String hibernateConnectionDriverClass, String user, String password) throws DatabaseConnectionException {
        ...
        DatabaseUtil.checkConnection(configuration);
    }
    ...
    public static void updateLegacyDatabase() {
        try {
            DatabaseUtil.dropModifiedTimeColumn();
        }
    ...
    private static void dropModifiedTimeColumn() throws SQLException {
        ...
        try {
            ...
            for (String table : tables = new String[]{"CUSTOMER", "GRATUITY", "INVENTORY_GROUP", "INVENTORY_ITEM", "INVENTORY_LOCATION", "INVENTORY_META_CODE", "INVENTORY_TRANSACTION", "INVENTORY_TRANSACTION_TYPE", "INVENTORY_UNIT", "INVENTORY_VENDOR", "INVENTORY_WAREHOUSE", "KITCHEN_TICKET", "KITCHEN_TICKET_ITEM", "MENUITEM_MODIFIERGROUP", "MENU_CATEGORY", "MENU_GROUP", "MENU_ITEM", "MENU_MODIFIER", "MENU_MODIFIER_GROUP", "PURCHASE_ORDER", "TAX", "TERMINAL", "TICKET", "TICKETITEM_MODIFIERGROUP", "TICKET_ITEM", "TICKETITEM_DISCOUNT", "TRANSACTIONS", "USERS", "ZIP_CODE_VS_DELIVERY_CHARGE"}) {
                try {
    ...
    public static boolean createDatabase(String connectionString, String hibernateDialect, String hibernateConnectionDriverClass, String user, String password, boolean exportSampleData) {
        try {
            ...
            configuration = configuration.setProperty("hibernate.c3p0.checkoutTimeout", "0");
            ...
            shift.setName(POSConstants.GENERAL);
            ...
            cashier.setPermissions(new HashSet<UserPermission>(Arrays.asList(UserPermission.CREATE_TICKET, UserPermission.SETTLE_TICKET, UserPermission.SPLIT_TICKET, UserPermission.VIEW_ALL_OPEN_TICKETS)));
